...
Widget wrapWithModel<T extends AzaBankModel>({
  required T model,
...
T createModel<T extends AzaBankModel>(
...
class AzaBankDynamicModels<T extends AzaBankModel> {
